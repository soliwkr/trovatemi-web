...
export function renderPublicCheck(check: PublicCheck): string {
  ...
  const css = [
    ':root{--ink:#101216;--paper:#f5f5ef;--surface:#fff;--soft:#f7f8f5;--line:#e2e4de;--muted:#6f757b;--blue:#246bfe;--yellow:#ffc400;--green:#169b62;--shadow:0 22px 70px rgba(17,20,24,.10);--shadow-soft:0 10px 30px rgba(17,20,24,.07)}',
    '*{box-sizing:border-box}html{background:var(--paper);color:var(--ink);font-family:Inter,ui-sans-serif,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;-webkit-text-size-adjust:100%;scroll-behavior:smooth}body{margin:0;background:var(--paper);-webkit-font-smoothing:antialiased}a{-webkit-tap-highlight-color:transparent}',
    '.brand{position:sticky;top:0;z-index:60;min-height:62px;padding:0 max(18px,env(safe-area-inset-left));display:flex;align-items:center;justify-content:space-between;background:rgba(245,245,239,.92);border-bottom:1px solid rgba(16,18,22,.08);backdrop-filter:blur(18px)}',
    ...
    '.section{position:relative;min-height:calc(100svh - 62px);display:flex;align-items:center;padding:64px 0;border-bottom:1px solid var(--line);overflow:hidden}.section.dark{background:var(--ink);color:#fff;border-color:#252629}.section.yellow{background:var(--yellow);color:var(--ink);border-color:#dba700}',
    ...
    '.search-shell{margin-top:30px;border:1px solid var(--line);border-radius:24px;overflow:hidden;background:#fff;box-shadow:var(--shadow)}.search-top{padding:18px;border-bottom:1px solid var(--line)}.search-box{display:flex;align-items:center;gap:12px;min-height:50px;padding:0 17px;border:1px solid #dfe1e5;border-radius:28px;box-shadow:0 1px 6px rgba(32,33,36,.12);color:#202124}.search-box span{font-size:1.35rem;color:#5f6368}.search-box b{font-size:.98rem}',
    ...
    '.compare-layout{display:grid;grid-template-columns:.88fr 1.12fr;gap:32px;align-items:center}.metric-card{padding:26px;border:1px solid var(--line);border-radius:24px;background:#fff}.metric-card.you{box-shadow:var(--shadow-soft)}.metric-card small{display:block;color:#70757a;font-size:.68rem;font-weight:800;letter-spacing:.08em}.metric-big{margin-top:10px;font-size:clamp(4rem,10vw,7rem);line-height:.85;font-weight:800;letter-spacing:-.06em}.metric-caption{margin-top:10px;color:#5f6368;font-weight:700}',
    ...
    '.journey-card{margin-top:28px;border:1px solid var(--line);border-radius:24px;background:#fff;overflow:hidden;box-shadow:var(--shadow-soft)}.signal-row{min-height:72px;padding:0 18px;display:flex;align-items:center;justify-content:space-between;border-top:1px solid #eceff1}.signal-row:first-child{border-top:0}.signal-row strong{display:block}.signal-row small{display:block;margin-top:4px;color:#7b8085}.signal-state{width:34px;height:34px;border-radius:50%;display:grid;place-items:center;background:#e7f4ea;color:var(--green);font-weight:900}.signal-state.no{background:#f1f3f4;color:#8a8f94}.journey-verdict{margin-top:20px;display:inline-block;padding:10px 13px;border-radius:9px;font-weight:900}',
